<template>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <b-card
          header="Device Performance Report"
          class="shadow-sm"
              ...
              <table class="table b-table table-striped table-bordered">
                <thead class="thead-light text-uppercase">
                  <tr>
                    ...
                    <th>Cash Out</th>
                    <th>Net Cash</th>
                    <th>Daily Cash In Per Device</th>
                    <th>Daily Net Per Device</th>
                  </tr>
                </thead>
                ...
                <tbody>
                  ...
                  <tr v-for="result in results" :key="result.id">
                    ...
                    <td>{{ $getFormattedPrice(result.netCash) }}</td>
                    <td>{{ $getFormattedPrice(result.dailyCashIn) }}</td>
                    <td>{{ $getFormattedPrice(result.dailyNet) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
